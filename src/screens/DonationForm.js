...
function DonationForm({ onProceed }) {
  ...
  const handleContinue = () => {
    ...
    const flatData = {
      ...
      donationCharity: selectedCharity,
      donationExplanation: charityExplanation,
      donationSubmitAt: currentTimestamp,
    };
            ...
            <FormControl component="fieldset">
              <RadioGroup value={selectedValue} onChange={handleDonationChange}>
                <FormControlLabel
                  value="0"
                  control={<Radio />}
                  label={`${currency}0 - No donation`}
                />
                <FormControlLabel
                  value="0.3"
                  control={<Radio />}
                  label={`${currency}0.3 (10%)`}
                />
                <FormControlLabel
                  value="0.75"
                  control={<Radio />}
                  label={`${currency}0.75 (25%)`}
                />
                <FormControlLabel
                  value="1.5"
                  control={<Radio />}
                  label={`${currency}1.5 (50%)`}
                />
                <FormControlLabel
                  value="2.25"
                  control={<Radio />}
                  label={`${currency}2.25 (75%)`}
                />
                <FormControlLabel
                  value="2.7"
                  control={<Radio />}
                  label={`${currency}2.7 (90%)`}
                />
                <FormControlLabel
                  value="3"
                  control={<Radio />}
                  label={`${currency}3 (100%)`}
                />
              </RadioGroup>
            </FormControl>
          </FormContainer>
        ...
        <Grid item xs={6}>
          ...
          >
                  ...
                  <FormControlLabel
                    ...
                    label={
                      <Box display="flex" alignItems="center">
                        <Typography
                          variant="body1"
                          sx={{ marginRight: 1, color: isDonationZero ? "gray" : "inherit" }}
                        >
                          {name}
                        </Typography>
            ...
            <Typography variant="body1" sx={{ mt: 2 }}>
              ...
              <span style={{ fontSize: "0.8em", fontStyle: "italic" }}>(Optional)</span>
            </Typography>
            <TextField
              fullWidth
              multiline
